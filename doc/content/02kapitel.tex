...
\hline
IntelliJ IDEA & Modulare IDE für Entwickler \\
\hline
...
\hline
NPM & Paketmanager für Javascript Umgebung Node.js \\
\hline
NGINX & Webserver Software \\ 
\hline
Angular & TypeScript-basiertes\newline Front-End-Webapplikationsframework \\
\hline
Docker & Containervirtualisierung \\
\hline
Kubernetes & Containerorchestrierung \\
\hline
Azure & Kubernetes Host \\
\hline
\end{tabular}
...
Als Frontend-CSS-Framework wurde MDBootstrap in der Version 9.3.1 verwendet. Die Entscheidung hierfür ist durch bestehende Erfahrungen aus Projekten der vorherigen Studienprojekte gefallen.
