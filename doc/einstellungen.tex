...
\setzekurs{TINF-18B}
\setzetitel{Implementierung eines auf dem MEAN-Stack basierenden Online-Shop Prototypen}
\setzedatumAbgabe{03. Juli 2020}
\setzefirma{Balluff GmbH, camos GmbH}
\setzefirmenort{Stuttgart}
\setzeabgabeort{Stuttgart}
\setzestudiengang{Informatik}
\setzedhbw{Stuttgart}
\setzebetreuer{Ingolf Buttig}
\setzegutachter{Ingolf Buttig}
